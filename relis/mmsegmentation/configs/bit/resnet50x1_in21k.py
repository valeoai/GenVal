...
ptcfg = {'file': '/gfs-ssd/project/uss/pre_trained_models/BiT/BiT-M-R50x1.npz'}
...
model = dict(
    ...
    backbone=dict(
        type='TIMMBackbone',
        model_name='resnetv2_50x1_bitm_in21k', #  / resnetv2_101x1_bitm / resnetv2_101x1_bitm_in21k
