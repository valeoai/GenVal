...
class SolverOps:
    ...
    def eval_auroc(self):
        ...
        all_logits, _ = self.create_labels_and_logits_stacks(logits_list, indices_list)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--date", type=str, default='2398478',
                        help="Dates, only for AROUND_LABELLED")
