...
(Prediction rejection ratio) for different datasets after temp scaling.
'''
...
for dset in ['CS', 'ACDC', 'IDD']:
    ...
    def get_results_dir(trg_dataset_, model_arch_, root_exp_dir_, n_clusters_, val_dset, clust_name, cluster_assignment, metric):
