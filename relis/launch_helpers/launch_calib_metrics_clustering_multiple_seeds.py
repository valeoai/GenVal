...
on different datasets after content dependant temperature scaling via clustering.
'''
...
for dset in ['CS', 'ACDC', 'IDD']:
    ...
    def get_results_dir(trg_dataset_, model_arch_, root_exp_dir_, n_clusters_, val_dset, clust_name, cluster_assignment, seed):
    ...
    #      val_dsets = [trg_dataset_, 'Cityscapes', 'All_dsets', 'Cityscapes_augmented']
                ...
                for n_clusters in [8]:
                    for val_dset in val_dsets:
                        ...
                        results_dir = get_results_dir(trg_dataset_, model_arch_,
                                                      ...
                                                      clust_name, cluster_assignment, seed)
