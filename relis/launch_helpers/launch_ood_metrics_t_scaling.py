...
are OOD. In this case logits are temperature scaled.
'''
...
for dset in ['All_dsets']:
    ...
    def get_results_dir(trg_dataset_, model_arch_, root_exp_dir_, n_clusters_, val_dset, clust_name,
                        cluster_assignment, metric):
        ...
        results_dir = os.path.join(f'{root_exp_dir_}Cityscapes/{model_arch_}',
                                   f'ood_metrics_clustering{metric}/{val_dset}/',
                                   f't_scaling/{trg_dataset_}/'
                                   )
        return results_dir
                ...
                for val_dset in val_dsets:
                    for metric in ['prob', 'entropy']:
                        ...
                        results_dir = get_results_dir(trg_dataset_, model_arch_,
                                                      ...
                                                      clust_name, cluster_assignment, metric)
                        ...
                        if os.path.isfile(done_filename) and not force_redo_:
                            ...
                            print(f'python -u eval_ood_clustering.py'+
